...
@time @test adversarialProblem([1, 3], [3, 1], [2, 2], 2, 0.5, [1.0, 0.0], getKnapsackConstraints([1, 2], 1)) == 6.0

# The worst second case scenario for α = 1.0 is [3, 3] which gives y = [0.0, 1.0]
@time @test adversarialProblem([1, 3], [3, 1], [2, 2], 2, 1.0, [1.0, 0.0], getKnapsackConstraints([1, 2], 1)) == 4.0
